...
#查看模型的摘要
print(model.summary())
#Param : 785000 = 784 * 1000 + 1000  h1 = X:上一層神經元(輸入層) * W1:該層神經元 + B1:該層神經元
#        100100 = 1000 * 100 + 100   h2 = h1:上一層神經元(隱藏層) * W2 + B2
#        1010 = 100 * 10 + 10      y = h2:上一層神經元(隱藏層) * W3 + B3
#總Params 886110 = 785000 + 100100 + 1010
...
#儲存訓練模型，參數為欲存放的位置
model.save('Models/Mnist_MLP_model.h5')
#讀取訓練模型，參數為模型的位置
model = keras.models.load_model('Models/Mnist_MLP_model.h5')
...
drow_pic.plot_images_labels_prediction(x_test_image,y_test_label,prediction,330,25)
...
#繪製出預測錯誤的影像
drow_pic.plot_image(x_test_image[1393])